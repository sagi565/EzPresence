...
export const DurationBadge = styled.span`
  ...
  color:white;
  background:#8b5cf6;
  box-shadow:0 0 0 1.5px ${p=>p.theme.colors.surface};
  border-radius:10px;
  padding:3px 5px;
  pointer-events:none;
